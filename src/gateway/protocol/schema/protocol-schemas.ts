...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  ChannelsAddParams: ChannelsAddParamsSchema,
  ChannelsRemoveParams: ChannelsRemoveParamsSchema,
  ChannelsLoginParams: ChannelsLoginParamsSchema,
  ChannelsListParams: ChannelsListParamsSchema,
  ChannelsCapabilitiesParams: ChannelsCapabilitiesParamsSchema,
  ChannelsResolveParams: ChannelsResolveParamsSchema,
  ChannelsLogsParams: ChannelsLogsParamsSchema,
  ...
  ToolsCallParams: ToolsCallParamsSchema,
  ToolsCallResult: ToolsCallResultSchema,
  ToolsListParams: ToolsListParamsSchema,
  ToolsListResult: ToolsListResultSchema,
  McpPresetsListParams: McpPresetsListParamsSchema,
  McpPresetFieldOption: McpPresetFieldOptionSchema,
  McpPresetField: McpPresetFieldSchema,
  McpPreset: McpPresetSchema,
  McpPresetsListResult: McpPresetsListResultSchema,
  McpProviderFieldValue: McpProviderFieldValueSchema,
  McpProviderState: McpProviderStateSchema,
  McpProvidersSnapshotParams: McpProvidersSnapshotParamsSchema,
  McpProvidersSnapshotResult: McpProvidersSnapshotResultSchema,
  McpProvidersApplyParams: McpProvidersApplyParamsSchema,
  McpFieldError: McpFieldErrorSchema,
  McpProvidersApplyResult: McpProvidersApplyResultSchema,
  McpMarketSearchParams: McpMarketSearchParamsSchema,
  McpMarketSearchResult: McpMarketSearchResultSchema,
  McpMarketDetailParams: McpMarketDetailParamsSchema,
  McpMarketDetailResult: McpMarketDetailResultSchema,
  McpMarketInstallParams: McpMarketInstallParamsSchema,
  McpMarketInstallResult: McpMarketInstallResultSchema,
  McpMarketUninstallParams: McpMarketUninstallParamsSchema,
  McpMarketUninstallResult: McpMarketUninstallResultSchema,
  McpMarketRefreshParams: McpMarketRefreshParamsSchema,
  McpMarketRefreshResult: McpMarketRefreshResultSchema,
