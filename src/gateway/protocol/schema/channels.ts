...
export const ChannelsAddParamsSchema = Type.Object(
  {
    ...
    groupChannels: Type.Optional(Type.Union([Type.String(), Type.Array(Type.String())])),
    dmAllowlist: Type.Optional(Type.Union([Type.String(), Type.Array(Type.String())])),
    dmPolicy: Type.Optional(Type.String()),
    allowFrom: Type.Optional(Type.Union([Type.String(), Type.Array(Type.String())])),
